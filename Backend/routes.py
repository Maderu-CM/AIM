...
def create_app():
    ...
    def add_data():
        ...
        # Check if the user is Admin or Procurement Manager
        if user_role in ['Admin', 'Procurement Manager']:
            data = request.get_json()

            # Validate the required fields in the incoming JSON data
...
# MVP: Manager Views Completed Requests
  ...
  # MVP: A user can request for new assets or repairs through a form stating the reason and quantity and urgency.
    ...
    # MVP: User Views Their Active and Completed Requests
